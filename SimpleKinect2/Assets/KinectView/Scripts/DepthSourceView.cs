...
public class DepthSourceView : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        OnSourceModeChanged.OnSourceChangedEvent += sourceModeChanged;
    }
    ...
    void Update()
    {
        ...
        if (ViewMode == DepthViewMode.SeparateSourceReaders)
        {
            ...
            _ColorManager = ColorSource.GetComponent<ColorSourceManager>();
            ...
            RefreshData(_DepthManager.GetData(),
                ColorSourceManager.ColorWidth,
                ColorSourceManager.ColorHeight);
        }
        else
        {
